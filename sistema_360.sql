...
--
-- Host: 127.0.0.1
-- Generation Time: 05-Jun-2019 às 22:37
...
INSERT INTO `topico` (`idTopico`, `nomeTopico`, `idTurma`, `Data`) VALUES
('T1A1', 'A aplicação de juros compostos no dia a dia', 'SI250A', '2019-02-02'),
('T1A2', 'Outro topico', 'SI250A', '2019-02-02'),
('T1A3', 'Mais um topico', 'SI250A', '2019-02-02'),
('T2A1', 'Novo topico', 'SI250A', '2019-02-09');
